...
async def create_test_group():
    ...
    """
    # Create telegram app
    app = telegram_connector.get_telegram_app()
    admin_username = get_env_or_raise(envs.TELEGRAM_ADMIN_HANDLE)
    bot_username = await telegram_connector.get_bot_username(app.bot)
    ...
    client = TelegramClient("create_chat_session", api_id=api_id, api_hash=api_hash)
    client.start()
